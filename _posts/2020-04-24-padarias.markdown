...
We can assume that the same happens in Lisbon, but until someone at [Metropolitano de Lisboa](https://www.metrolisboa.pt/) replies to my emails requesting turnstile data I won't be able to find out. ([Figure 2](###fig.-2-total-area-of-influence))