...
- Comparing orange area with grey area was not feasible because of exterior projects (see Martim Moniz Square for an example, marked with a black star). This is a large project that doesn't actually involve any building;
